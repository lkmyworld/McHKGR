...
class McHKGR(nn.Module):
    ...
    def calc_cf_embeddings(self, user_ids, item_ids):
        ...
        loss_contrast = self.calculate_loss(user_f_image, user_f_text) + \
                        self.calculate_loss(all_embed_image[item_ids], all_embed_text[item_ids])
    ...
    def calc_train(self, user_ids, item_ids, labels):
        ...
        l2_loss = self.L2_loss_mean(user_embed) + self.L2_loss_mean(item_embed)
